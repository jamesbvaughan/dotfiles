...
vim.keymap.set("n", "<leader>d", function() Snacks.bufdelete() end, { desc = "Close the current buffer" })
vim.keymap.set("n", "<leader>n", function() Snacks.notifier.show_history() end, { desc = "Show notification history" })
vim.keymap.set("n", "gh", function() Snacks.gitbrowse.open() end, { desc = "Open the current file on the web" })
...
vim.keymap.set("n", "<leader>fc", pick("git_files", { cwd = "~/.dotfiles", untracked = true }), { desc = "Search dotfiles repo" })
